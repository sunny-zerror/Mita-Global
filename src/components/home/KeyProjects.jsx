                    ...
                    <div className="space-y-1">
                        {projectsData.map((project, index) => {
                            ...
                            return (
                                <div
                                    key={project.id}
                                    className={`w-full md:h-170 flex justify-between gap-1 flex-col ${index === 1
                                        ...
                                        <div className="space-y-12">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 w-full max-w-80">
                                                {project.tags.map((tag, i) => (
                                                    <div
                                                        key={i}
                                                        className="border whitespace-nowrap uppercase text-xs w-fit flex items-center gap-x-2 p-3 pb-2 leading-none border-[#0f1219]"
                                                    >
