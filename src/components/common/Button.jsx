...
const Button = ({ text, link = "/", theme = "dark", className = "text-sm pb-2" }) => {
  return (
    <Link href={link} className={` center shrink-0 h-fit block uppercase group  ${theme === "dark" ? " bg-[#0f1219] text-[#f2f2f2] " : "bg-[#f2f2f2] text-[#0f1219]"} w-fit p-3   leading-none ${className}` }>
